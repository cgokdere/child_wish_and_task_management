...
public class Task {
	...
	public Task(String assignedBy, int task_id, String title, String description, LocalDateTime deadlineDate,
			int points) {
	...
	public Task(String assignedBy, int task_id, String title, String description, LocalDateTime startDate,
	...
	public String getTaskDetails() {
		String idStr = String.format("ID:%-4d", Task_id);
